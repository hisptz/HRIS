...
class DepartmentController extends Controller
{
    ...
    public function generateAction(Request $request)
    {
        ...
        //creating array of selected forms
        $formsArray = array();
        $formString="";
...
//        echo $query; die();
     ...
     * @Route("/download", name="department_download")
     * @Method("GET")
     * @Template()
     */
     ...
     * @Route("/records", name="department_nursing_download_records")
     * @Method("GET")
     * @Template()
     */
    public function recordsAction(Request $request)
    {
        ...
        $formsArray = explode("_",$formsId);
        array_pop($formsArray);
        $results = $this->nursingRecords1($organisationUnit, $formsArray,$withLowerLevels,$startdate,$enddate,$carde,$licence);
