...
class DashboardController extends Controller
{
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_DASHBOARD_LIST")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_DASHBOARD_CREATE")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_DASHBOARD_SHOW")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_DASHBOARD_UPDATE")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_DASHBOARD_DELETE")
