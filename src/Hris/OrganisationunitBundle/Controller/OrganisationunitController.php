...
class OrganisationunitController extends Controller
{
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_ORGANISATIONUNIT_LIST")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_ORGANISATIONUNIT_CREATE")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_ORGANISATIONUNIT_SHOW")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_ORGANISATIONUNIT_DELETE")
    ...
    public function treeAction($_format)
    {
        ...
        if($id == NULL || $id==0) {
            ...
            $organisationunitQuery = $em->createQuery("SELECT organisationunit.id,organisationunit.uid,organisationunit.longname,
                                                        ...
                                                        FROM HrisOrganisationunitBundle:Organisationunit organisationunit
                                                        WHERE organisationunit.id=:organisationunitid
                                                        GROUP BY organisationunit.id,organisationunit.uid,organisationunit.longname
                                                        ORDER BY organisationunit.longname ASC")->setParameter('organisationunitid',$organisationunit);;
            ...
            $organisationunitQuery = $em->createQuery("SELECT organisationunit.id,organisationunit.uid,organisationunit.longname,
                                                        ...
                                                        GROUP BY organisationunit.id,organisationunit.uid,organisationunit.longname
                                                        ORDER BY organisationunit.longname ASC")->setParameter('parentid',$id);
...
/**
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_ORGANISATIONUNIT_LISTTREE,ROLE_USER")
     * @Route("/trainingtree.{_format}", requirements={"_format"="yml|xml|json"}, defaults={"_format"="json"}, name="organisationunit_training_tree")
     * @Method("GET")
     * @Template()
     */
    public function trainingtreeAction($_format)
    {
...
//            }
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_ORGANISATIONUNITGROUP_LISTTREE")
     * @Route("/group/{organisationunitgroupid}/tree.{_format}", requirements={"_format"="yml|xml|json","organisationunitgroupid"="\d+"}, defaults={"_format"="json","organisationunitgroupid"=0}, name="organisationunit_tree_group_members")
     * @Method("GET")
     * @Template()
     */
